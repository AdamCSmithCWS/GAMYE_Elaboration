...
species_f <- gsub(species,pattern = " ",replacement = "_")
        ...
        out_base <- paste0(species_f,"_real_Non_spatial","BBS")
        mod.file = "models/gamye_iCAR_bbs_Non_spatial.stan"
        print(paste("beginning",species,"with non spatial BBS",Sys.time()))
